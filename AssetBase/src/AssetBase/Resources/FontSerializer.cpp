...
flatbuffers::Offset<Assets::Font> FontSerializer::Serialize(flatbuffers::FlatBufferBuilder& builder, const std::filesystem::path& base_path, const std::string& name, YAML::Node atlas, bool debug_mode) const
{
