...
namespace Li
{
		...
		WrapType wrap_s, WrapType wrap_t, FilterType min_filter, FilterType mag_filter, bool dynamic)
	{
		...
		case RendererAPI::OpenGL:
			return MakeRef<OpenGLTexture2D>(width, height, channels, data, wrap_s, wrap_t, min_filter, mag_filter);
#endif
#ifdef LI_INCLUDE_D3D11
		case RendererAPI::D3D11:
			return MakeRef<D3D11Texture2D>(width, height, channels, data, wrap_s, wrap_t, min_filter, mag_filter, dynamic, false);
#endif
		}
...
#ifdef LI_INCLUDE_OPENGL
		case RendererAPI::OpenGL:
			return MakeRef<OpenGLTexture2D>(path, desired_channels, wrap_s, wrap_t, min_filter, mag_filter);
#endif
#ifdef LI_INCLUDE_D3D11
		case RendererAPI::D3D11:
			return MakeRef<D3D11Texture2D>(path, desired_channels, wrap_s, wrap_t, min_filter, mag_filter);
#endif
		}
...
#ifdef LI_INCLUDE_OPENGL
		case RendererAPI::OpenGL:
			return MakeRef<OpenGLTexture2D>(image_size, encoded_data, desired_channels, wrap_s, wrap_t, min_filter, mag_filter);
#endif
#ifdef LI_INCLUDE_D3D11
		case RendererAPI::D3D11:
			return MakeRef<D3D11Texture2D>(image_size, encoded_data, desired_channels, wrap_s, wrap_t, min_filter, mag_filter);
#endif
		}
