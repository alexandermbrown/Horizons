if(NOT TARGET unofficial::libvpx::libvpx)
  ...
  find_library(_LIBFILE_RELEASE NAMES vpx vpxmd PATHS "${_IMPORT_PREFIX}/lib/" NO_DEFAULT_PATH)
  ...
  if(ON)
    find_library(_LIBFILE_DEBUG NAMES vpx vpxmdd PATHS "${_IMPORT_PREFIX}/debug/lib/" NO_DEFAULT_PATH)
    set_property(TARGET unofficial::libvpx::libvpx
